...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.prefs_autorun = QAction(MainWindow)
        self.prefs_autorun.setObjectName(u"prefs_autorun")
        self.prefs_autorun.setCheckable(True)
        ...
        self.menuPreferences.addAction(self.prefs_autorun)
        self.menuPreferences.addAction(self.prefs_automin)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.prefs_autorun.setText(QCoreApplication.translate("MainWindow", u"Start MouseTracks at Login", None))
