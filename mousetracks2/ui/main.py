...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionMinimise_to_Tray_on_Close = QAction(MainWindow)
        self.actionMinimise_to_Tray_on_Close.setObjectName(u"actionMinimise_to_Tray_on_Close")
        self.actionMinimise_to_Tray_on_Close.setCheckable(True)
        self.actionMinimise_to_Tray_on_Close.setChecked(True)
        self.actionMinimise_to_Tray_on_Close.setEnabled(False)
        ...
        self.thumbnail = QLabel(self.verticalLayoutWidget)
        ...
        self.verticalLayout_11.addWidget(self.thumbnail)

        self.save_render = QPushButton(self.verticalLayoutWidget)
        self.save_render.setObjectName(u"save_render")
        sizePolicy1 = QSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Fixed)
        sizePolicy1.setHorizontalStretch(0)
        sizePolicy1.setVerticalStretch(0)
        sizePolicy1.setHeightForWidth(self.save_render.sizePolicy().hasHeightForWidth())
        self.save_render.setSizePolicy(sizePolicy1)

        self.verticalLayout_11.addWidget(self.save_render)
        ...
        sizePolicy1.setHeightForWidth(self.current_profile.sizePolicy().hasHeightForWidth())
        self.current_profile.setSizePolicy(sizePolicy1)
        ...
        self.gridLayout_3.addWidget(self.stat_distance, 3, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.stat_keys, 1, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.stat_buttons, 2, 1, 1, 1)
        ...
        self.menuPreferences.addAction(self.actionMinimise_to_Tray_on_Close)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionMinimise_to_Tray_on_Close.setText(QCoreApplication.translate("MainWindow", u"Minimise On Close", None))
        ...
        self.stat_active.setText(QCoreApplication.translate("MainWindow", u"45.20 hours", None))
        ...
        self.label_19.setText(QCoreApplication.translate("MainWindow", u"Distance Moved:", None))
        self.stat_clicks.setText(QCoreApplication.translate("MainWindow", u"526462", None))
        self.stat_inactive.setText(QCoreApplication.translate("MainWindow", u"5.31 hours", None))
