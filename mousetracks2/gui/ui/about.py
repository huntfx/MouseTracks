...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.latest.setProperty(u"text_install", QCoreApplication.translate("Dialog", u"A new version is ready to launch.<br/>Restart to complete the installation.", None))
