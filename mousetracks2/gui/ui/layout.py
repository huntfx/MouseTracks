...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.recording_start.setToolTip(QCoreApplication.translate("MainWindow", u"Switch back into live mode.", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.playback_exit.setToolTip(QCoreApplication.translate("MainWindow", u"Switch back into live mode.", None))
#endif // QT_CONFIG(tooltip)
