...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tray_open_exe_dir = QAction(MainWindow)
        self.tray_open_exe_dir.setObjectName(u"tray_open_exe_dir")
        self.tray_open_data_dir = QAction(MainWindow)
        self.tray_open_data_dir.setObjectName(u"tray_open_data_dir")
        ...
        self.menu_advanced = QMenu(self.tray_context_menu)
        self.menu_advanced.setObjectName(u"menu_advanced")
        self.menu_debug = QMenu(self.menu_advanced)
        ...
        self.tray_context_menu.addSeparator()
        self.tray_context_menu.addAction(self.menu_advanced.menuAction())
        self.tray_context_menu.addAction(self.tray_about)
        self.tray_context_menu.addSeparator()
        self.tray_context_menu.addAction(self.tray_exit)
        self.menu_advanced.addAction(self.tray_open_exe_dir)
        self.menu_advanced.addAction(self.tray_open_data_dir)
        self.menu_advanced.addSeparator()
        self.menu_advanced.addAction(self.menu_debug.menuAction())
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tray_open_exe_dir.setText(QCoreApplication.translate("MainWindow", u"Open Executable Folder", None))
        self.tray_open_data_dir.setText(QCoreApplication.translate("MainWindow", u"Open Data Folder", None))
...
"For example, it can be limited to Alpha to copy the transparency.", None))
        ...
        self.tip.setProperty(u"tip_install", QCoreApplication.translate("MainWindow", u"A new version is ready to launch. Restart MouseTracks to complete the installation.", None))
#if QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.history_length.setToolTip(QCoreApplication.translate("MainWindow", u"Set how many minutes of live history is kept in memory.\n"
"This is not saved to any profile.", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.recording_start.setToolTip(QCoreApplication.translate("MainWindow", u"Start saving a live recording to a file.", None))
#endif // QT_CONFIG(tooltip)
        self.recording_start.setText(QCoreApplication.translate("MainWindow", u"Start Recording to Disk", None))
#if QT_CONFIG(tooltip)
        self.recording_stop.setToolTip(QCoreApplication.translate("MainWindow", u"Export the current replay to disk.\n"
"\n"
"The range settings are taken into account.", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.playback_start.setToolTip(QCoreApplication.translate("MainWindow", u"Start time offset of the replay.", None))
#endif // QT_CONFIG(tooltip)
        self.playback_start.setText(QCoreApplication.translate("MainWindow", u"1h 23m", None))
#if QT_CONFIG(tooltip)
        self.playback_range.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>Set the playback range.</p><p><br/></p><p>The left handle controls when playback starts.</p><p>The right handle controls when playback ends.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.playback_end.setToolTip(QCoreApplication.translate("MainWindow", u"End time offset of the replay.", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.playback_progress.setToolTip(QCoreApplication.translate("MainWindow", u"The current replay progress.", None))
#endif // QT_CONFIG(tooltip)
        self.label_12.setText(QCoreApplication.translate("MainWindow", u"Speed:", None))
#if QT_CONFIG(tooltip)
        self.playback_speed.setToolTip(QCoreApplication.translate("MainWindow", u"The speed to play back the replay.", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.playback_speed_visual.setToolTip(QCoreApplication.translate("MainWindow", u"The current speed of the replay.", None))
#endif // QT_CONFIG(tooltip)
        self.playback_speed_visual.setText(QCoreApplication.translate("MainWindow", u"1.0x", None))
#if QT_CONFIG(tooltip)
        self.playback_skip.setToolTip(QCoreApplication.translate("MainWindow", u"Skip over any ticks where nothing happened.", None))
#endif // QT_CONFIG(tooltip)
        self.playback_skip.setText(QCoreApplication.translate("MainWindow", u"Skip Idle Time", None))
#if QT_CONFIG(tooltip)
        self.playback_play.setToolTip(QCoreApplication.translate("MainWindow", u"Play the current replay.", None))
#endif // QT_CONFIG(tooltip)
        self.playback_play.setText(QCoreApplication.translate("MainWindow", u"Play", None))
#if QT_CONFIG(tooltip)
        self.playback_pause.setToolTip(QCoreApplication.translate("MainWindow", u"Pause the current replay.", None))
#endif // QT_CONFIG(tooltip)
        self.playback_pause.setText(QCoreApplication.translate("MainWindow", u"Pause", None))
#if QT_CONFIG(tooltip)
        self.playback_export.setToolTip(QCoreApplication.translate("MainWindow", u"Export the current replay to disk.\n"
"\n"
"The range settings are taken into account.", None))
#endif // QT_CONFIG(tooltip)
        self.playback_export.setText(QCoreApplication.translate("MainWindow", u"Export", None))
#if QT_CONFIG(tooltip)
        self.playback_enter.setToolTip(QCoreApplication.translate("MainWindow", u"Switch into playback mode.", None))
#endif // QT_CONFIG(tooltip)
        self.playback_enter.setText(QCoreApplication.translate("MainWindow", u"Enter Replay Mode", None))
#if QT_CONFIG(tooltip)
        self.playback_exit.setToolTip(QCoreApplication.translate("MainWindow", u"Start saving a live recording to a file.", None))
#endif // QT_CONFIG(tooltip)
